...
The [19-color terminal extension](../../README.md#higher-contrast-terminals) preserves the supplied **Solarized Dark Higher Contrast** scheme's colors except its background. Richer ANSI colors and distinct bright variants are shared with VS Code's integrated terminal and, since 0.5.0, Alacritty.
