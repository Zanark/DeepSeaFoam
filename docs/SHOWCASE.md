...
The reading path is **hero/workspace → surface hierarchy → editorial rationale/photo reference → palette → applications → interaction study → anglerfish → download → footer/blobfish**. Applications immediately follow the palette. The nautilus is no longer an inline section or spacer: it occupies a root-level scene layer independently of document flow, above the ocean but below readable content. The old four principle cards, four-item signal legend, and heritage/extension block are retired from the page; the research narrative and interaction study remain. Creature placement is composition, not biological depth ordering, and the 0–2,000 m gauge is explicitly narrative. ([site/index.html:70–86](../site/index.html#L70-L86), [site/index.html:228–327](../site/index.html#L228-L327), [site/index.html:405–539](../site/index.html#L405-L539), [scripts/validate-site.mjs:217–239](../scripts/validate-site.mjs#L217-L239), `updateScene`, [site/ocean.js:71–91](../site/ocean.js#L71-L91))
...
| Creature reveals | Native checkboxes and CSS reveal/retract the angler and footer blobfish; no disclosure script or expanding card is required. ([site/index.html:435–468](../site/index.html#L435-L468), [site/index.html:508–539](../site/index.html#L508-L539), [site/ocean.css:354–392](../site/ocean.css#L354-L392)) |
...
The site cap remains **3 MiB across every deployed file**, including the 2,817,068-byte MP3 and the photographic preview. The user's explicit request to display the photograph adds a separate **48 KiB photo allowance**; **256 KiB still bounds all remaining non-audio assets**, for a maximum **304 KiB non-audio total**. This is an explicit budget change, not an uncounted image or an exclusion for license files. Recursive counting includes every artwork/module/product SVG/notice and `.nojekyll`; no file is omitted from the overall cap. ([site/icons/NOTICE.txt:4–19](../site/icons/NOTICE.txt#L4-L19), [scripts/validate-site.mjs:131–142](../scripts/validate-site.mjs#L131-L142), `listAssets` / `totalBytes` / `budget` / `interfaceBytes`, [scripts/validate-site.mjs:289–314](../scripts/validate-site.mjs#L289-L314))

The foreground contract additionally retains decorative local plants, the bounded side mask, soft blur and dedicated sway. Browser review must inspect text bounds throughout the page (including narrow footer credits), compare foreground-on/off pixels outside the edge strips, and sample both plants across their sway before checking pause/reduced-motion/no-JavaScript behavior. Plant counts alone cannot prove clear text or visible edge foliage. ([scripts/validate-site.mjs:255–268](../scripts/validate-site.mjs#L255-L268))

Validation checks the thirteen-card/icon inventory, Monkeytype's fill-only derivation and shared license, blobfish and photo-preview integrity, photo attribution/markup, required controls, initial dive-state/versioned-script markers, section order, behind-content layering contract and research limits. It does not prove visual kelp occlusion, installed-app compatibility, or comfort. Browser acceptance must additionally cover wide/narrow viewports; decoded full-composition photo placement and stable pre-load dimensions; credited keyboard-operable source links without an automatic external image request; seeded nautilus motion/bounds and paint below reading content; native click/tap-through; paused positioning; intro hiding; no-JavaScript/reduced-motion fallback; and pinch/visual-viewport containment. Phone emulation is not physical-device or Safari validation. ([scripts/validate-site.mjs:50–151](../scripts/validate-site.mjs#L50-L151), [scripts/validate-site.mjs:189–250](../scripts/validate-site.mjs#L189-L250), [scripts/test-nautilus.mjs:25–140](../scripts/test-nautilus.mjs#L25-L140), [scripts/test-nautilus.mjs:340–414](../scripts/test-nautilus.mjs#L340-L414), [scripts/test-nautilus.mjs:481–500](../scripts/test-nautilus.mjs#L481-L500))
